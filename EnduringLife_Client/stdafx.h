...
#define FRAME_BUFFER_WIDTH		1440//1280//640 	//1440		 
#define FRAME_BUFFER_HEIGHT	900//700//480 	//900			 
...
#define ROOT_PARAMETER_TEXTURE		5 //몬스터도 쓰셈여

#define ROOT_PARAMETER_TEXTURETRANS 12   //물 애니메이션
...
namespace Matrix4x4
{
	...
	{
		XMFLOAT4X4 xmmtx4x4Result;
		XMStoreFloat4x4(&xmmtx4x4Result, XMMatrixOrthographicLH(FRAME_BUFFER_WIDTH, FRAME_BUFFER_HEIGHT, NearZ, FarZ));
		return(xmmtx4x4Result);
